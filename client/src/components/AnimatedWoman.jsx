...
Command: npx gltfjsx@6.2.15 public/models/Animated Woman.glb -o src/components/AnimatedWoman.jsx -r public 
*/
...
export function AnimatedWoman({
  ...
  // useGraph creates tow flat object collections for nodes and materials
